...
* Connect your client to the server via TCP to port 1337
...
* Connect to the server at port 1337
...
* If you look at the GUI, you'll find a reset button. You can use it to wipe out the GUI board and make it forget all previous state. This way for the server version, you can restart your clients without having to restart the server. If you are good at python, you can modify this to allow for automatic running of many games without having to touch the terminal or GUI. We didn't write this as this requires cooperation of the clients and you could write your own client in another language.
